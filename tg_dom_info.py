...
async def cmd_start(message: Message):
    await message.answer(
        "<b>Привет!</b> Я помогу узнать технические характеристики жилого дома.\n\n"
        "<b>Как пользоваться:</b>\n"
        "Просто отправь адрес дома — город обязателен:\n"
        "<code>Уфа, Ленина, 70</code>\n"
        "<code>г Уфа, ул Менделеева, д 156 к 3</code>\n\n"
        "Или отправь <b>геолокацию</b> 📍 — определю адрес автоматически.\n\n"
        "<b>Что покажу:</b>\n"
        "• Год постройки и материал стен\n"
        "• Этажность, количество квартир и подъездов\n"
        "• Тип водоснабжения, отопления, перекрытий\n"
        "• Кадастровый номер и ID ФИАС\n"
